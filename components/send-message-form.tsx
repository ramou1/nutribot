  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      <ReactTextareaAutosize
        ...
        className="w-full rounded-2xl border border-[#e5e5e5] bg-[#fafafa] dark:bg-[#2d2d2d] dark:border-[#404040] px-4 py-3 pr-12 text-[#344e41] dark:text-[#e9e9e9] placeholder:text-[#666666]/50 dark:placeholder:text-[#9e9e9e]/50 focus:outline-none focus:ring-2 focus:ring-[#588157] dark:focus:ring-[#3a5a40] resize-none"
